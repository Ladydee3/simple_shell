 ...
 *
 * Return: string containing history file allocated
 */
...
/**
 * write_history - file created or appends to an existing one
 * @info: struct parameter
 *
 * Return: on success 1 elae -1
 */
...
/**
 * renumber_history - history linked list remembered after
 *                changes
